...
#include "../../examples/C/Hash/MatchForDeviceId.c"

class ExampleHashTestMatchForDeviceId : public ExampleHashTest {
public:
...
EXAMPLE_HASH_TESTS(ExampleHashTestMatchForDeviceId)
