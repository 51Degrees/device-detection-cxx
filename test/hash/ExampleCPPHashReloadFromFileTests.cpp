...
#include "../../examples/CPP/Hash/ReloadFromFile.cpp"


class ExampleCPPHashReloadFromFileTests : public ExampleHashTest {
public:
...
EXAMPLE_HASH_TESTS(ExampleCPPHashReloadFromFileTests)