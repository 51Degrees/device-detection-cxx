...
#include "../../examples/C/Pattern/ProcPat.c"

class ExamplePatternTestProcPattern : public ExamplePatternTest {
public:
	void run(fiftyoneDegreesConfigPattern config) {
		...
		int count = fiftyoneDegreesProcPatternRun(
			dataFilePath.c_str(),
			"IsMobile",
			&config);
...
EXAMPLE_PATTERN_TESTS(ExamplePatternTestProcPattern)
