...
#include "../../examples/C/Pattern/ReloadFromFile.c"

class ExamplePatternTestReloadFromFile : public ExamplePatternTest {
public:
...
EXAMPLE_PATTERN_TESTS(ExamplePatternTestReloadFromFile)