...
#include "../../examples/C/Pattern/ReloadFromMemory.c"

class ExamplePatternTestReloadFromMemory : public ExamplePatternTest {
public:
...
EXAMPLE_PATTERN_TESTS(ExamplePatternTestReloadFromMemory)