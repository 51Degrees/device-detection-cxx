...
#include "../../examples/C/Pattern/MatchMetrics.c"

class ExamplePatternTestMatchMetrics : public ExamplePatternTest {
public:
...
EXAMPLE_PATTERN_TESTS(ExamplePatternTestMatchMetrics)
