...
/**
@example Pattern/ReloadFromMemory.cpp
...
2. Use the EnginePattern->refreshData() function to reload the dataset from the
...
The EnginePattern->refreshData() function requires an existing resource with
...
namespace FiftyoneDegrees {
	namespace Examples {
		namespace Pattern {
			/**
			 * Pattern Reload From Memory Example.
			 */
			class ReloadFromMemory : public ExampleBase {
			public:
				/**
				 * @copydoc ExampleBase::ExampleBase(byte*, long, DeviceDetection::Pattern::ConfigPattern*)
