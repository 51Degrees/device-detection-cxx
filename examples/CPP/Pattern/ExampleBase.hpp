...
namespace FiftyoneDegrees {
	namespace Examples {
		/**
		 * C++ Pattern engine examples.
		 */
		namespace Pattern {
			/**
			 * Base class extended by all Pattern examples.
			 */
			class ExampleBase {
			public:
				 ...
				 */
				ExampleBase(byte *data, long length, ConfigPattern *config);
				 ...
				 * @param config to configure the engine with
				 */
				ExampleBase(string dataFilePath, ConfigPattern *config);
			...
			protected:
				...
				public:
					 ...
					 */
					SharedState(EnginePattern *engine, string userAgentFilePath);
					...
					EnginePattern *engine; /**< Pointer to the engine */
				...
				public:
					 ...
					 * use
					 */
					ThreadState(EnginePattern *engine);
					EnginePattern *engine; /**< Pointer to the engine */
				...
				/** Pattern Engine used for the example */
