...
/**
@example Pattern/FindProfiles.c
...
property value pair.
```
fiftyoneDegreesPatternIterateProfilesForPropertyAndValue(
	manager,
	"IsMobile",
	"True",
	&isMobileTrue,
...
void run(ResourceManager* manager) {
	...
	PatternIterateProfilesForPropertyAndValue(
		manager,
		"IsMobile",
		"True",
		&isMobileTrue,
...
void fiftyoneDegreesPatternFindProfiles(
...
int main(int argc, char* argv[]) {
	...
	fiftyoneDegreesPatternFindProfiles(dataFilePath, CONFIG);
