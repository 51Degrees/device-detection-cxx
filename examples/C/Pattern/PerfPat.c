 ...
 * MACROS.
 * NOTE: BALANCED WILL NOT RESULT IN GOOD PERFORMANCE IN THIS TEST DUE TO 
 * THREADING CONTENTION WITH THE CACHE. LOW AND HIGH WILL AVOID THIS.
 */
 ...
 */
void reportProgress(performanceThreadState *state) {
	EXCEPTION_CREATE;
	char deviceId[40] = "";
 ...
 */
void fiftyoneDegreesPerfPatternRun(
	...
	// Ensure the cache is not used as this example measures performance 
	// without a User-Agent cache. 
...
int main(int argc, char* argv[]) {
	...
	fiftyoneDegreesPerfPatternRun(dataFilePath, userAgentFilePath, CONFIG);
