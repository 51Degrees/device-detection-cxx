...
#ifndef FIFTYONE_DEGREES_PROFILE_META_DATA_BUILDER_PATTERN_HPP
#define FIFTYONE_DEGREES_PROFILE_META_DATA_BUILDER_PATTERN_HPP
...
namespace FiftyoneDegrees {
	namespace DeviceDetection {
		namespace Pattern {
			 ...
			 * building profile meta data instances from a Pattern data set.
			 */
			class ProfileMetaDataBuilderPattern : EntityMetaDataBuilder {
			public:
				/**
