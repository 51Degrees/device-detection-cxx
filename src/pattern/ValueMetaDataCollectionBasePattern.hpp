...
#ifndef FIFTYONE_DEGREES_VALUE_META_DATA_COLLECTION_BASE_PATTERN_HPP
#define FIFTYONE_DEGREES_VALUE_META_DATA_COLLECTION_BASE_PATTERN_HPP
...
namespace FiftyoneDegrees {
	namespace DeviceDetection {
		namespace Pattern {
			/**
			 * A collection of all value meta data contained in a Pattern
			 * engine.
			 */
			class ValueMetaDataCollectionBasePattern
			...
			public:
				 ...
				 */
				  ...
				  * data set
				  */
				ValueMetaDataCollectionBasePattern(
					fiftyoneDegreesResourceManager *manager);

				/**
				 * Releases the data set being referenced by the collection.
				 */
				virtual ~ValueMetaDataCollectionBasePattern();
