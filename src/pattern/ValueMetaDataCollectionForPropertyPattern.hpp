...
#ifndef FIFTYONE_DEGREES_VALUE_META_DATA_COLLECTION_FOR_PROPERTY_PATTERN_HPP
#define FIFTYONE_DEGREES_VALUE_META_DATA_COLLECTION_FOR_PROPERTY_PATTERN_HPP
...
namespace FiftyoneDegrees {
	namespace DeviceDetection {
		namespace Pattern {
			 ...
			 * in a Pattern engine.
			 */
			class ValueMetaDataCollectionForPropertyPattern
			...
			public:
				 ...
				 * must relate to
				 */
				ValueMetaDataCollectionForPropertyPattern(
