...
#ifndef FIFTYONE_DEGREES_COMPONENT_META_DATA_BUILDER_PATTERN_HPP
#define FIFTYONE_DEGREES_COMPONENT_META_DATA_BUILDER_PATTERN_HPP
...
namespace FiftyoneDegrees {
	namespace DeviceDetection {
		namespace Pattern {
			 ...
			 * building component meta data instances from a Pattern data set.
			 */
			class ComponentMetaDataBuilderPattern : EntityMetaDataBuilder {
			public:
				/**
