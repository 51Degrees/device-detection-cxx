...
#ifndef FIFTYONE_DEGREES_COMPONENT_META_DATA_COLLECTION_PATTERN_HPP
#define FIFTYONE_DEGREES_COMPONENT_META_DATA_COLLECTION_PATTERN_HPP
...
namespace FiftyoneDegrees {
	namespace DeviceDetection {
		namespace Pattern {
			/**
			 * A collection of component meta data contained in a Pattern
			 * engine.
			 */
			class ComponentMetaDataCollectionPattern
			...
			public:
				 ...
				 * data set
				 */
				ComponentMetaDataCollectionPattern(
