...
#ifndef FIFTYONE_DEGREES_PROPERTY_META_DATA_COLLECTION_PATTERN_HPP
#define FIFTYONE_DEGREES_PROPERTY_META_DATA_COLLECTION_PATTERN_HPP
...
namespace FiftyoneDegrees {
	namespace DeviceDetection {
		namespace Pattern {
			/**
			 * A collection of all property meta data contained in a Pattern
			 * engine.
			 */
			class PropertyMetaDataCollectionPattern
			...
			public:
				 ...
				 * set
				 */
				PropertyMetaDataCollectionPattern(
