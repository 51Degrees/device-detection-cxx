...
#ifndef FIFTYONE_DEGREES_VALUE_META_DATA_COLLECTION_FOR_PROFILE_PATTERN_HPP
#define FIFTYONE_DEGREES_VALUE_META_DATA_COLLECTION_FOR_PROFILE_PATTERN_HPP

#include "../common-cxx/Collection.hpp"
#include "../common-cxx/ProfileMetaData.hpp"
#include "ValueMetaDataCollectionBasePattern.hpp"
#include "ValueMetaDataBuilderPattern.hpp"
#include "pattern.h"
...
namespace FiftyoneDegrees {
	namespace DeviceDetection {
		namespace Pattern {
			/**
			 * A collection of value meta data relating to a profile contained in
			 * a Pattern engine.
			 */
			class ValueMetaDataCollectionForProfilePattern
				: public ValueMetaDataCollectionBasePattern {
			public:
				/**
				 ...
				 * relate to
				 */
				ValueMetaDataCollectionForProfilePattern(
