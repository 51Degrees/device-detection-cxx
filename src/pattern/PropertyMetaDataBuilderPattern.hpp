...
#ifndef FIFTYONE_DEGREES_PROPERTY_META_DATA_BUILDER_PATTERN_HPP
#define FIFTYONE_DEGREES_PROPERTY_META_DATA_BUILDER_PATTERN_HPP
...
namespace FiftyoneDegrees {
	namespace DeviceDetection {
		namespace Pattern {
			 ...
			 * building property meta data instances from a Pattern data set.
			 */
			class PropertyMetaDataBuilderPattern : EntityMetaDataBuilder {
			public:
				/**
